<?php
/*
Plugin Name: Sociable Polska Edycja
Plugin URI: http://blog.keepmind.eu/tag/sociable
Description: Automatycznie dodaje linki Twoich wpisów, stron oraz kanałów RSS do ulubionych zakładek portali społecznych.
Version: 1.0.0
Author: inzaghi89
Author URI: http://keepmind.eu
...
## Polska Edycja by inzaghi89 ##

	'Arttuba' => Array(
        'favicon' => 'arttuba.png',
        'url' => 'http://www.arttuba.com/dodaj?url=PERMALINK,title,TITLE%20-%20PERMALINK',
        'description' => 'Arttuba',
	),
	
	'Bebo' => Array(
        'favicon' => 'bebo.png',
        'url' => 'http://bebo.gazeta.pl/c/share?Page=c/share&Page=c/share&amp;Url=PERMALINK&amp;Title=TITLE%20-%20PERMALINK',
        'description' => 'Bebo',
	),

	'Blip' => Array(
        'favicon' => 'blip.png',
        'url' => 'http://blip.pl/dashboard?body=TITLE%20-%20PERMALINK',
        'description' => 'Blip',
	),
	
	'Blogger' => Array(
        'favicon' => 'blogger.png',
        'url' => 'http://www.blogger.com/blog-this.g?t=EXCERPT&amp;u=PERMALINK&amp;n=TITLE',
        'description' => 'Blogger.com',
	),
	
	'co-robie' => Array(
        'favicon' => 'co-robie.png',
        'url' => 'http://co-robie.pl/home/?add=TITLE%20-%20PERMALINK',
        'description' => 'co-robie',
	),
	
	'Dotnetomaniak' => Array(
        'favicon' => 'dotnetomaniak.png',
        'url' => 'http://dotnetomaniak.pl/Submit?title=TITLE&amp;url=PERMALINK',
        'description' => 'Dotnetomaniak',
	),
	
	'elefanta' => Array(
        'favicon' => 'elefanta.png',
        'url' => 'http://elefanta.pl/member/bookmarkNewPage.action?url=PERMALINK&amp;title=TITLE',
        'description' => 'elefanta',
	),
	
	'Flaker' => Array(
        'favicon' => 'flaker.png',
        'url' => 'http://flaker.pl/add2flaker.php?title=TITLE&amp;url=PERMALINK',
        'description' => 'Flaker',
	),
	
	'Forumowisko' => Array(
        'favicon' => 'forumowisko.png',
        'url' => 'http://www.forumowisko.pl/index.php?app=forums&amp;module=post&amp;section=post&amp;do=new_post&amp;f=76&amp;get_title=TITLE&amp;get_post=PERMALINK',
        'description' => 'Forumowisko',
	),
	
	'Gadu-Gadu Live' => Array(
        'favicon' => 'gadu-gadulive.png',
        'url' => 'http://www.gadu-gadu.pl/polec?title=TITLE&amp;url=PERMALINK&amp;desc=EXCERPT',
        'description' => 'Gadu-Gadu Live',
	),
	
	'Google Buzz' => Array(
        'favicon' => 'buzz.png',
        'url' => 'http://www.google.com/buzz/post?message=EXCERPT&amp;url=PERMALINK',
        'description' => 'Google Buzz',
	),
	
	'Grono.net' => Array(
        'favicon' => 'grono.png',
        'url' => 'http://grono.net/pub/page/link/urlfetch/?url=PERMALINK&amp;title=TITLE',
        'description' => 'Grono.net',
	),
	...
	'Linkologia' => Array(
        'favicon' => 'linkologia.png',
        'url' => 'http://www.linkologia.pl//link-add/?url=PERMALINK&amp;title=TITLE',
        'description' => 'Linkologia',
	),
	
	'Mój biznes' => Array(
        'favicon' => 'mojbiznes.png',
        'url' => 'http://www.mojbiznes.pl/dodaj?url=PERMALINK,title,TITLE',
        'description' => 'Mój biznes',
	),
	
	'OSnews' => Array(
        'favicon' => 'osnews.png',
        'url' => 'http://osnews.pl/dodaj-niusa/?external=true&amp;title=TITLE&amp;url=PERMALINK&amp;content=EXCERPT',
        'description' => 'OSnews',
	),
	
	'Pinger' => Array(
        'favicon' => 'pinger.png',
        'url' => 'http://www.pinger.pl/share?title=TITLE&amp;content=PERMALINK%20-%20EXCERPT',
        'description' => 'Pinger',
	),
	
	'Poleć' => Array(
        'favicon' => 'polec.png',
        'url' => 'http://www.polec.pl/submit?url=PERMALINK',
        'description' => 'Poleć',
	),
	
	'Sfora' => Array(
        'favicon' => 'sfora.png',
        'url' => 'http://www.sfora.pl/Link/Wysforuj/?Link=PERMALINK&amp;Tytul=TITLE&amp;Opis=EXCEPRT',
        'description' => 'Sfora',
	),
	...
	'Śledzik' => Array(
        'favicon' => 'sledzik.png',
        'url' => 'http://nasza-klasa.pl/sledzik?shout=TITLE%20-%20PERMALINK',
        'description' => 'Śledzik',
	),
	
	'Ulubione' => Array(
		'favicon' => 'ulubione.png',
		'url' => 'http://www.ulubione.org/addurl.php?url=PERMALINK',
		'description' => 'Ulubione',
	),
	
	'Wahacz' => Array(
		'favicon' => 'wahacz.png',
		'url' => 'http://www.wahacz.pl/login.php?url=PERMALINK,title,TITLE%20-%20PERMALINK',
		'description' => 'Wahacz',
	),
	
	'Woomer' => Array(
		'favicon' => 'woomer.png',
		'url' => 'http://www.woomer.pl/dodaj?title=TITLE&amp;content=TITLE%20-%20PERMALINK',
		'description' => 'Woomer',
	),
	
	'Wykop' => Array(
		'favicon' => 'wykop.png',
		'url' => 'http://www.wykop.pl/dodaj/link/url,PERMALINK,title,TITLE,desc,EXCERPT',
	...
	'Yam' => Array(
		'favicon' => 'yam.png',
		'url' => 'http://yam.pl?text=TITLE%20-%20PERMALINK',
		'description' => 'Yam',
	),
...
function sociable_html($display=array()) {
	...
	foreach($display as $sitename) {
		...
		if (get_option('sociable_useiframe') && !isset($site['supportsIframe'])) {
			...
			if(!($sitename=="Dodaj do ulubionych")) {
...
function sociable_js() {
	...
	if (in_array('Dodaj do ulubionych',get_option('sociable_active_sites'))) {
		global $sociablepluginpath;
